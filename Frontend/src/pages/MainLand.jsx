...
function MainLand() {
    ...
    const leaderboardData = [
        ...
        },
        {
            ...
            profileImage: "https://ichef.bbci.co.uk/ace/standard/976/cpsprodpb/16620/production/_91408619_55df76d5-2245-41c1-8031-07a4da3f313f.jpg",
                            ...
                            <div className="flex-grow">
                                <div className="flex justify-between">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <p className={`text-xs ${asset.dailyChange > 0 ? 'text-green-600' : 'text-red-600'}`}>
                                ...
                                <div className="mt-4 flex justify-around">
                                    ...
                                    <button className="bg-gray-400 text-white px-3 py-1 rounded hover:bg-gray-500 transition">
                                        Don&apos;t sell me pls
                                    </button>
                                </div>
                            </div>
